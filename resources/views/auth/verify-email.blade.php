      ...
      <main class="px-7 py-10 sm:px-10">
        <div class="mx-auto max-w-md">
          ...
          <form method="POST" action="{{ route('verification.resend') }}" class="mt-6 space-y-3">
            ...
            <div>
              <label class="block text-xs font-extrabold text-zinc-800 dark:text-zinc-200">{{ __('auth.verify_email.email_label') }}</label>
              <input
                type="email"
                name="email"
            ...
            <a
              href="/?openLogin=1"
              class="block text-center text-sm font-semibold text-zinc-600 hover:text-zinc-900 dark:text-zinc-300 dark:hover:text-white"
            >
