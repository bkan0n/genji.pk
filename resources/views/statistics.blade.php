    ...
    <div class="mx-auto max-w-7xl space-y-5 px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        ...
        <div class="rounded-2xl border border-zinc-200/80 dark:border-white/10 bg-zinc-100 dark:bg-white/5 p-4">
          ...
          <div
            class="mt-3 rounded-xl border border-zinc-200/80 dark:border-white/10 bg-white/40 dark:bg-zinc-900/40 p-2 ring-1 ring-zinc-300/60 dark:ring-white/10"
          >
        ...
        <div class="rounded-2xl border border-zinc-200/80 dark:border-white/10 bg-zinc-100 dark:bg-white/5 p-4">
          <div class="flex items-center justify-between gap-2">
            ...
            <div class="flex items-center gap-2">
              <label for="difficultySelect" class="text-[11px] text-zinc-500 dark:text-zinc-400">
                {{ __('statistics.difficulty') }}
              </label>
              <select
                id="difficultySelect"
                class="focus:ring-brand-500/40 rounded-md border border-zinc-200/80 dark:border-white/10 bg-white/60 dark:bg-zinc-900/60 px-2.5 py-1.5 text-xs focus:ring-2 focus:outline-none"
              ></select>
            </div>
          </div>
          <div
        ...
        <div class="rounded-2xl border border-zinc-200/80 dark:border-white/10 bg-zinc-100 dark:bg-white/5 p-4">
          <div class="flex items-center justify-between">
            ...
            <p class="text-[11px] text-zinc-500 dark:text-zinc-400">{{ __('statistics.top25') }}</p>
          </div>
          <div
            class="mt-3 rounded-xl border border-zinc-200/80 dark:border-white/10 bg-white/40 dark:bg-zinc-900/40 p-2 ring-1 ring-zinc-300/60 dark:ring-white/10"
          >
        ...
        <div class="rounded-2xl border border-zinc-200/80 dark:border-white/10 bg-zinc-100 dark:bg-white/5 p-4">
          ...
          <div
            class="mt-3 flex items-center justify-center overflow-hidden rounded-xl border border-zinc-200/80 dark:border-white/10 bg-white/40 dark:bg-zinc-900/40 ring-1 ring-zinc-300/60 dark:ring-white/10"
          >
