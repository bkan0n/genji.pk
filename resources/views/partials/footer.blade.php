      ...
      <div>
        ...
        <div class="flex gap-3">
          <a
            ...
            class="inline-flex items-center justify-center rounded-lg border border-white/10 p-2 hover:bg-white/5"
            aria-label="Discord" title="Discord"
          >
            <svg class="block h-5 w-5 overflow-visible text-white" viewBox="0 0 256 199" aria-hidden="true">
          ...
          >
            <svg class="block h-5 w-5 overflow-visible" viewBox="0 0 24 24" aria-hidden="true">
