  ...
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="grid items-start gap-4 sm:grid-cols-3 lg:grid-cols-4">
      <div>
        ...
        <p class="text-xs leading-5 text-zinc-400">{{ __('footer.tagline') }}</p>
      </div>
      ...
      <nav>
        ...
        <ul class="space-y-1 text-xs leading-5">
          <li><a class="text-zinc-300 hover:text-white" href="{{ url('/leaderboard') }}">{{ __('footer.discover.leaderboard') }}</a></li>
          <li><a class="text-zinc-300 hover:text-white" href="{{ url('/search') }}">{{ __('footer.discover.maps') }}</a></li>
          <li><a class="text-zinc-300 hover:text-white" href="{{ url('/tutorials') }}">{{ __('footer.discover.guides') }}</a></li>
        </ul>
      </nav>
      ...
      <div>
        ...
        <div class="flex gap-2">
          <a
            ...
            class="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-white/10 p-1.5 hover:bg-white/5"
            aria-label="Discord" title="Discord"
          >
            <svg class="block h-4 w-4 overflow-visible text-white" viewBox="0 0 256 199" aria-hidden="true">
