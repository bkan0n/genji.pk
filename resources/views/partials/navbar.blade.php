@php
  ...
  if (!$avatarUrl && session('user_id') && session('user_avatar')) {
    $avatarUrl = 'https://cdn.discordapp.com/avatars/' . session('user_id') . '/' . session('user_avatar') . '.png';
  }
  $username =
  session('user_name')
