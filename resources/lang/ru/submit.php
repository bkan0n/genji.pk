...
return [
    ...
    */
    ...
    'record' => [
        ...
        'uploading_screenshot' => 'Загрузка скриншота…',
    ...
    'playtest' => [
        ...
        'cannot_vote_own_map'  => 'Вы не можете голосовать за свою собственную карту',
        'vote_value'           => 'Значение голоса',
        'voted_difficulty'     => 'Выбранная сложность',
    ],
    ...
    'popup' => [
        ...
        'none'                           => 'N/A',
        'no_overwatch_usernames_prompt'  => 'У вас не указано ни одного Overwatch-ника, хотите добавить его сейчас?',
        'yes'                            => 'Да',
        'no'                             => 'Нет',
    ],
