...
rule ("OverPy | Player Translation Setup") {
    ...
    action {
        ...
        Start Facing(Event Player, Direction From Angles(Multiply(10, Index Of Array Value(Global.__overpyTranslationHelper__, String Split(Color(흰색), Empty Array))), 5), 999999999999, To World, Direction and Turn Rate);
    ...
    action {
        ...
        If(Compare((Event Player).cache_bounceTouched, >=, Null));
            ...
            If(Value In Array(Global.TQ5, (Event Player).cache_bounceTouched));
                ...
                Small Message(Event Player, Custom String("   {0} {1}", Ability Icon String(Hero(겐지), Button(Ultimate)), Value In Array(String Split(Custom String("Ultimate Is ReadyUltimate Is ReadyUltimate Is Ready"), Global.__overpyTranslationHelper__), (Local Player).__languageIndex__)));
            End;
            If(Value In Array(Global.TQ6, (Event Player).cache_bounceTouched));
                ...
                Small Message(Event Player, Custom String("   {0} {1}", Ability Icon String(Hero(겐지), Button(Ability 1)), Value In Array(String Split(Custom String("Dash Is ReadyDash Is ReadyDash Is Ready"), Global.__overpyTranslationHelper__), (Local Player).__languageIndex__)));
            End;
    ...
    action {
        ...
        If(Global.CompMode);
            If(Global.instructiontext);
                Create HUD Text((Local Player).comp_instructionHud, Null, Null, Global.instructiontext, Top, -180, Null, Null, Color(흰색), Visible To, Default Visibility);
            End;
            Create HUD Text((Local Player).comp_instructionHud, Custom String("　　　　　Press {0} To Start　　　　　", Input Binding String(Button(Interact))), Null, Null, Top, -176, Color(흰색), Null, Null, Visible To and String, Default Visibility);
...
rule ("Huds | Leaderboard") {
    ...
    action {
        ...
        Create HUD Text((Local Player).toggle_guide, Null, Custom String(" \\n{0} {1} {0}", Icon String(Flag), Value In Array(String Split(Custom String("Top 5Top 5Top 5"), Global.__overpyTranslationHelper__), (Local Player).__languageIndex__)), Null, Right, -141, Null, Color(흰색), Null, Visible To and String, Visible Always);
        ...
        If(Value In Array(Global.LeaderBoardFull, True));
            ...
            End;
        End;
        Create HUD Text((Local Player).toggle_leaderboard, Custom String("　　　　 {0} {1} {0} 　　　　\\n　　　　　　　　　　　　　　　　　　{2}", Icon String(Flag), Value In Array(String Split(Custom String("LeaderboardLeaderboardLeaderboard"), Global.__overpyTranslationHelper__), (Local Player).__languageIndex__), Evaluate Once(Global.LeaderBoardRemake)), Null, Null, Top, -165, Color(흰색), Null, Null, Visible To and String, Default Visibility);
        Modify Global Variable(LeaderBoardHuds, Append To Array, Last Text ID);
...
rule ("Addon | Preset Control Map Portal - Toggle Via Workshop Settings") {
    ...
    action {
        ...
        Else If(Compare(Custom String("{0}", Current Map), ==, Custom String("{0}", Map(사모아))));
    ...
    action {
        ...
        While(Compare(Count Of(Global.C), >, 1));
            ...
            While(Compare(First Of(Global.C), <, 256));
                투사체 생성(구형 투사체, Null, Add(Value In Array(Global.C, True), Multiply(30, Vector(Subtract(Modulo(First Of(Global.C), 16), 8), False, Subtract(Round To Integer(Divide(First Of(Global.C), 16), Down), 8)))), Down, To World, Heal, Team 1, 0, 0, 30, Good Explosion, Explosion Sound, 1, 1, 0, 0, 0, 0);
        ...
        While(Count Of(Global.C));
            ...
            투사체 생성(구형 투사체, Null, First Of(Global.C), Down, To World, Heal, Team 1, 0, 0, 30, Good Explosion, Explosion Sound, 1, 1, 0, 0, 0, 0);
