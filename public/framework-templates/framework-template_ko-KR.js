...
export const frameworkTemplate = `settings
{
	main
	{
		모드 이름: "Genji Parkour - 源氏跑酷 - v1.10.4F"
    ...
    action {
        ...
        If(Compare((Event Player).cache_bounceTouched, >=, Null));
            ...
            If(Value In Array(Global.TQ5, (Event Player).cache_bounceTouched));
                ...
                Small Message(Event Player, Custom String("   {0} {1}", Ability Icon String(Hero(겐지), Button(Ultimate)), Value In Array(String Split(Custom String("ＴＬＥｒｒUltimate Is ReadyUltimate Is ReadyUltimate Is Ready"), Global.__overpyTranslationHelper__), (Local Player).__languageIndex__)));
            End;
            If(Value In Array(Global.TQ6, (Event Player).cache_bounceTouched));
                ...
                Small Message(Event Player, Custom String("   {0} {1}", Ability Icon String(Hero(겐지), Button(Ability 1)), Value In Array(String Split(Custom String("ＴＬＥｒｒDash Is ReadyDash Is ReadyDash Is Ready"), Global.__overpyTranslationHelper__), (Local Player).__languageIndex__)));
            End;
...
rule ("Huds | Leaderboard") {
    ...
    action {
        ...
        Create HUD Text((Local Player).toggle_guide, Null, Custom String(" \\n{0} {1} {0}", Icon String(Flag), Value In Array(String Split(Custom String("ＴＬＥｒｒTop 5Top 5Top 5"), Global.__overpyTranslationHelper__), (Local Player).__languageIndex__)), Null, Right, -141, Null, Color(흰색), Null, Visible To and String, Visible Always);
        ...
        If(Value In Array(Global.LeaderBoardFull, True));
            ...
            End;
        End;
        Create HUD Text((Local Player).toggle_leaderboard, Custom String("　　　　 {0} {1} {0} 　　　　\\n　　　　　　　　　　　　　　　　　　{2}", Icon String(Flag), Value In Array(String Split(Custom String("ＴＬＥｒｒLeaderboardLeaderboardLeaderboard"), Global.__overpyTranslationHelper__), (Local Player).__languageIndex__), Evaluate Once(Global.LeaderBoardRemake)), Null, Null, Top, -165, Color(흰색), Null, Null, Visible To and String, Default Visibility);
        Modify Global Variable(LeaderBoardHuds, Append To Array, Last Text ID);
    ...
    action {
        ...
        While(Compare(Count Of(Global.C), >, 1));
            ...
            While(Compare(First Of(Global.C), <, 256));
                투사체 생성(구형 투사체, Null, Add(Add(Subtract(Value In Array(Global.C, True), Vector(240, False, 240)), Multiply(Modulo(First Of(Global.C), 16), Multiply(30, Left))), Multiply(Round To Integer(Divide(First Of(Global.C), 16), Down), Multiply(30, Forward))), Down, To World, Heal, Team 1, 0, 0, 30, Good Explosion, Explosion Sound, 1, 1, 0, 0, 0, 0);
