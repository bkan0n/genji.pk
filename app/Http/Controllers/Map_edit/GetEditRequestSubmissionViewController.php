...
class GetEditRequestSubmissionViewController extends BaseMapEditController
{
    public function show(Request $request, int $edit_id)
    {
        ...
        $endpoint = $this->endpoint('/api/v3/maps/map-edits/' . $edit_id . '/submission');
        ...
        try {
            ...
            Log::error('GetEditRequestSubmissionView upstream exception', [
                'edit_id' => $edit_id,
                'error'   => $e->getMessage(),
            ]);
