...
class GenerateQuestRotationController extends Controller
{
    public function __invoke(Request $request)
    {
        ...
        $endpoint = $apiRoot . '/api/v3/store/admin/quests/rotation/generate';
        ...
        try {
            ...
            Log::error('Admin quests rotation generate upstream exception', ['error' => $e->getMessage()]);
