...
class DeleteAllPlaytestVotesController extends Controller
{
    public function destroy(string $thread_id): JsonResponse
    {
        ...
        $url = "{$root}/api/v3/maps/playtests/{$thread_id}/vote";
