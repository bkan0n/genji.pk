...
class GetQuestHistoryController extends Controller
{
    public function index(Request $request, int $user_id)
    {
        ...
        $endpoint = $apiRoot . '/api/v3/store/users/' . $data['user_id'] . '/quest-history';
        ...
        try {
            ...
            Log::error('Quest history upstream exception', [
                'error' => $e->getMessage(),
